...
elabExpr expr = case expr of
  ...
  B.CompareRatTensorPointwiseEq tk -> builtinFunction (V.CompareRatTensor V.Eq) tk [_, _]
  B.CompareRatTensorPointwiseNe tk -> builtinFunction (V.CompareRatTensor V.Ne) tk [_, _]
  B.CompareRatTensorPointwiseLe tk -> builtinFunction (V.CompareRatTensor V.Le) tk [_, _]
  B.CompareRatTensorPointwiseLt tk -> builtinFunction (V.CompareRatTensor V.Lt) tk [_, _]
  B.CompareRatTensorPointwiseGe tk -> builtinFunction (V.CompareRatTensor V.Ge) tk [_, _]
  B.CompareRatTensorPointwiseGt tk -> builtinFunction (V.CompareRatTensor V.Gt) tk [_, _]
