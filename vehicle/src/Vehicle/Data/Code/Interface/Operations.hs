...
type RatTensorPointwiseComparisonAccessor expr thunk builtin op = Accessor (expr builtin) (op, TensorOp2Args (thunk builtin))

type RatTensorReducedComparisonAccessor expr thunk builtin op = Accessor (expr builtin) (op, TensorReduceComparisonArgs (thunk builtin))
...
accessCompareRatTensorPointwise :: (HasBoolExpr expr thunk builtin) => RatTensorPointwiseComparisonAccessor expr thunk builtin ComparisonOp
accessCompareRatTensorPointwise = accessOpAndArgs accessCompareRatTensorPointwiseBuiltin

accessCompareRatTensorReduced :: (HasBoolExpr expr thunk builtin) => RatTensorReducedComparisonAccessor expr thunk builtin ComparisonOp
